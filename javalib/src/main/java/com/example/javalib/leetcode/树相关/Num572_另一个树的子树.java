 ...
 */
public class Num572_另一个树的子树 {
    public static void main(String[] args) {
        Num572_另一个树的子树 num572另一个树的子树 = new Num572_另一个树的子树();
...
//        TreeNode treeNode2 = num572.initTree(new int[]{4, 11, 0, 7, 2, 0, 0});
        TreeNode treeNode1 = Tree.initTree(new int[]{1, 1});
        TreeNode treeNode2 = Tree.initTree(new int[]{1});
        System.out.println(num572另一个树的子树.isSubtree(treeNode1, treeNode2));
