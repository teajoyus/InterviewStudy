...
public class MyDefinedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_defined);
...
//            return super.getItemViewType(position);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            Log.i(TAG,"ViewHolder onCreateViewHolder");
            View v = null;
            if (viewType == 2) {
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            Log.i(TAG,"ViewHolder onBindViewHolder position:"+position);
...
//    }
    ...
    class NormalAdapterWrapper extends RecyclerView.Adapter{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            if(viewType==-1){
                RelativeLayout layout = new RelativeLayout(MyDefinedActivity.this);
        ...
        class HeaderViewHolder extends RecyclerView.ViewHolder{
            ...
            public HeaderViewHolder(View itemView) {
                super(itemView);
                tv = new TextView(MyDefinedActivity.this);
